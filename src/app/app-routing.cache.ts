...
export class AppRoutingCache implements RouteReuseStrategy {
  ...
  public retrieve(route: ActivatedRouteSnapshot): DetachedRouteHandle {
    ...
    console.log("AppRoutingCache.handlers[route.routeConfig.path]",AppRoutingCache.handlers[route.routeConfig.path]);
    //let aa = AppRoutingCache.handlers[route.routeConfig.path];
    //aa.componentRef.instance.listOfRandomUser[0].name="wwwwwwwww";
